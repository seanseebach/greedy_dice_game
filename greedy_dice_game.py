...
print('The game is called greedy.\n\nThe rules are simple:\nPlayers go around in a circle rolling 2 dice with the goal of "locking in" at over 100 points.')
print('Your score is the sum of your dice roll.\nOnce you have a score you can either keep rolling or lock in your score.\nWhen you lock in you start at that score on the next round.')
print('If you roll a 1, that turn''s rolls do not count and you go back to previous score.')
print('If you roll two 1''s, then your turn is over and you go back to a 0 score.')
print('If you roll doubles that are not 1''s, then you double the sum and add it to your score.\n')
print('Once a player has chosen to lock in at over 100, the final round starts.')
print('After that, everyone gets one turn to try to beat the winner.')
print('The player with the most points after this round wins!\n')
print('Are you ready to start playing Greedy?  (Press Enter)')
input()
